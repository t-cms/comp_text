...
## do not reload this block unless adding more articles to analysis, becuase it will add more articles to the already set folder rin my lapto  ### 
# Reformat .RTF files
# Load required packages
# Set the paths for your folders
input_folder <- "./DEI_updated_files/master_folder_dei/"  # Replace with your input folder path
...
## reload this after deleting the file raw text stuff, try to locate 200 missing files 
```
...
<RESTART, RERUN AFTER SECURING ARTICLES AND INDEX> 
...
{start here and finish then rewrite the new insights into the rmd file knit it to html and add to paper}
## Topic Modeling
...
control + left click + option = file path 
